...
namespace Tests
{
    public class CarTests
    {
        ...
        [TestCase("Маке", "", 10, 100)]
        [TestCase("Маке", null, 10, 100)]
        [TestCase("Маке", "Model", 0, 100)]
        [TestCase("Маке", "Model", -10, 100)]
        [TestCase("Make", "Model", 10, 0)]
        [TestCase("Make", "Model", 10, -50)]
        public void CtorThrowsException_WhenDataIsInvalid(string make, string model, double fuelConsumption, double fuelCapacity)
        {
        ...
        [Test]
        public void Drive_ThrowException_WhenTankIsEmpty()
        {
        ...
        [Test]
        public void Drive_DecreaseFuelAmountToZero_WhenRequaredFuelIsEqualToFuelAmount()
        {
